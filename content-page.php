        <div class="artical-content" id="post-<?php the_ID(); ?>" <?php post_class('page'); ?>>
            <h3 class="ghj"><?php the_title(); ?></h3>
        ...
        <div class="artical-links">
            <ul>
                ...
                <li><a href="<?php the_permalink(); ?>"><small class="admin"> </small><span><?php the_author(); ?></span></a></li>
